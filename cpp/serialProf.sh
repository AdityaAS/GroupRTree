...
./output $1 output_$1\_EPS=$Epsilon\_MINPOINTS=$MINPOINTS\_nodes=$5\_threads=$6.txt $GMINENTRIES $GMAXENTRIES $GAUXMINENTRIES $GAUXMAXENTRIES $RMINENTRIES $RMAXENTRIES $Epsilon $MINPOINTS $UNDEFINED cluster_$1\_EPS=$Epsilon\_MINPOINTS=$MINPOINTS\_nodes=$5\_threads=$6.txt $6

# mpirun -hostfile hostlist -np $5 ./output $path1$1 output_$1\_EPS=$Epsilon\_MINPOINTS=$MINPOINTS\_nodes=$5\_threads=$6.txt $GMINENTRIES $GMAXENTRIES $GAUXMINENTRIES $GAUXMAXENTRIES $RMINENTRIES $RMAXENTRIES $Epsilon $MINPOINTS $UNDEFINED cluster_$1\_EPS=$Epsilon\_MINPOINTS=$MINPOINTS\_nodes=$5\_threads=$6.txt $6
